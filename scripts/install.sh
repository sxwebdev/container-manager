...
TEMP_DIR="/tmp/container-manager-install-$$"
...
usage() {
    ...
    echo "  $0 -d /opt/container-manager/bin              # Custom install directory"
    echo "  $0 -u cmuser -s container-manager-svc         # Custom user and service name"
    echo "  $0 -v v1.0.0                                  # Install specific version"
    echo ""
    echo "This script will:"
    echo "  1. Download the latest Container Manager release for your platform"
...
print_info "Starting Container Manager installation..."
...
# Final information
echo ""
print_success "Container Manager installation completed successfully!"
echo ""
...
echo "  The container manager will help you manage Docker Compose services"
echo "  Configure your services in the config file above"
echo ""
print_info "Upgrade:"
echo "  Run: curl -L https://raw.githubusercontent.com/sxwebdev/container-manager/master/scripts/upgrade.sh | sudo bash -s $SERVICE_NAME"
